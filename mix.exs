defmodule SynologyZipper.MixProject do
  use Mix.Project
  ...
  def application do
    [
      mod: {SynologyZipper.Application, []},
  ...
  defp aliases do
    [
      ...
      "assets.build": ["tailwind synology_zipper", "esbuild synology_zipper"],
      "assets.deploy": [
        "tailwind synology_zipper --minify",
        "esbuild synology_zipper --minify",
        "phx.digest"
      ]
    ]
  end
